...
config = ConfigReader("../../configs/final_run/fashion_mnist/cnn/non_federated.yaml")
...
model = build_small_cnn_model(input_shape, label_count)
...
print("Training the two layer cnn model ...")
for iteration_counter in range(1, max_iterations + 1):
    ...
    print("Testing the two layer cnn model ...")
