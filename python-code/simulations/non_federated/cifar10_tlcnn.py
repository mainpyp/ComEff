...
config = ConfigReader("../../configs/final_run/cifar10/tlcnn/done/non_federated.yaml")
...
model = build_tl_cnn_model(input_shape, label_count)
...
print("Training the three layer cnn model ...")
for iteration_counter in range(1, max_iterations + 1):
    ...
    print("Testing the three layer cnn model ...")
